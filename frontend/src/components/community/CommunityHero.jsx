  ...
  return (
    <section className="mb-3">
      <div className="relative overflow-hidden rounded-2xl border border-ink-200/70 bg-gradient-to-br from-paper-50/95 via-white/92 to-paper-200/72 px-5 py-4 sm:px-6 sm:py-5">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-white/14 via-white/10 to-white/22" />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-white/52 via-white/26 to-transparent" />
