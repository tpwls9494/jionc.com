...
function CommunityHero() {
  ...
  return (
    <section className="mb-3">
      <div className="relative overflow-hidden rounded-2xl border border-ink-200/70 bg-gradient-to-br from-paper-50/95 via-paper-50/92 to-paper-200/72 px-5 py-4 sm:px-6 sm:py-5">
        <CommunityHeroConstellation />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-paper-50/10 via-paper-50/6 to-paper-50/16" />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-paper-50/42 via-paper-50/16 to-transparent" />
